...
class BannerViewMedium : RelativeLayout {
    ...
    private fun init(context: Context, attrs: AttributeSet?) {
        ...
        val rootView = inflater.inflate(R.layout.ad_view_banner_view_medium, this, true)
        ...
        val a = context.obtainStyledAttributes(attrs, R.styleable.BannerViewMedium)
        isShouldLoadDirect =
            a.getBoolean(R.styleable.BannerViewMedium_shouldLoadDirectBannerMedium, true)
